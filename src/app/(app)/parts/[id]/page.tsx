...
export default async function PartDetailPage({
  ...
  return (
    <div className="space-y-6">
      <div>
        <Link href="/parts" className="text-sm text-slate-500 hover:text-slate-900">
          ← Back to parts
        </Link>
        <div className="flex items-center gap-3 mt-1">
          <h1 className="text-2xl font-semibold text-slate-900">{part.part_number}</h1>
      ...
      <div className="grid md:grid-cols-2 gap-6">
        ...
        <div className="bg-white border border-slate-200 rounded-lg">
          <div className="px-4 py-3 border-b border-slate-200">
            <h2 className="font-medium text-slate-900">Shipment History</h2>
          </div>
          {shipments.length === 0 ? (
            <p className="px-4 py-6 text-sm text-slate-500">This part hasn&apos;t been shipped yet.</p>
          ) : (
