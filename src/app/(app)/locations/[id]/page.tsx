  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <p className="text-sm text-slate-500">Store #{location.store_number}</p>
      ...
      <div className="grid md:grid-cols-2 gap-6">
        ...
        >
          <h2 className="font-medium text-slate-900">Location Details</h2>
        ...
        <div className="bg-white border border-slate-200 rounded-lg">
          <div className="px-4 py-3 border-b border-slate-200">
            <h2 className="font-medium text-slate-900">Service History</h2>
          </div>
          {requests.length === 0 ? (
            <p className="px-4 py-6 text-sm text-slate-500">No service requests for this location yet.</p>
          ) : (
                ...
                <li key={r.id} className="px-4 py-3">
                  ...
                  <div className="mt-1 flex items-center gap-2 flex-wrap">
                    ...
                    {r.service_company_name && (
                      <span className="text-xs text-slate-500">· {r.service_company_name}</span>
                    )}
                  </div>
                </li>
              ))}
